...
public class PublicLinkedSetTest {
  ...
  public void print() {
	   ...
	   set1.adjoin("q");
	   set1.adjoin("q");set2.adjoin("q");set3.adjoin("q");
	    System.out.println("\nsize is: "+set1.size());
	    ...
	    for (String a : set4) {
	        ...
	        System.out.println("\nnewsize is: "+set1.union(set4).size());
  ...
  public void testAdjoinImmutability() {
    ...
    for (String a : set2) {
        System.out.print(a);} 
    System.out.println("\ntestAdjoinImmutability");
    
    assertEquals("adjoin should not modify the set", set1, set2);
  }
